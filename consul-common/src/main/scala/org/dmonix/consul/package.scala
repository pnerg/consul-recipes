...
package object consul {
  ...
  case class Session(
      ...
      lockDelay: Option[FiniteDuration] = None,
  ...
  /**
    ...
    */
  case class GetKeyValue(
      key: String,
      modifyIndex: Option[Int] = None,
      maxWait: Option[FiniteDuration] = None,
  ...
  /**
    ...
    */
  case class SetKeyValue(
      key: String,
      value: Option[String] = None,
      compareAndSet: Option[Int] = None,
      acquire: Option[SessionID] = None,
      release: Option[SessionID] = None
  ) {
    import spray.json._
